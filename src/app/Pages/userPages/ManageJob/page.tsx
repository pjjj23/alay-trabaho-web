                ...
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    {!loading && !error && (
                        <div className="divide-y divide-gray-200">
                            {/* Header Row */}
                            <div className="grid grid-cols-2 px-6 py-3 bg-gray-50 text-sm font-medium text-gray-500">
                            ...
                            {applications.length === 0 ? (
                                ...
                                applications.map((app) => (
                                    <div
                                        ...
                                        className="grid grid-cols-2 px-6 py-4 hover:bg-gray-50 transition-all duration-200 cursor-pointer group"
                                    >
